...
final class PopupBox extends EditBox {
    ...
    /*public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float delta) {*/
        ...
        graphics.fill(x + 1, y + 1, x + width - 1, y + height - 1, GlassUI.FILL);
        graphics.fill(x + 1, y, x + width - 1, y + 1, this.isFocused() ? GlassUI.BORDER_BRIGHT : GlassUI.BORDER);
        graphics.fill(x + 1, y + height - 1, x + width - 1, y + height, this.isFocused() ? GlassUI.BORDER_BRIGHT : GlassUI.BORDER);
        graphics.fill(x, y + 1, x + 1, y + height - 1, this.isFocused() ? GlassUI.BORDER_BRIGHT : GlassUI.BORDER);
        graphics.fill(x + width - 1, y + 1, x + width, y + height - 1, this.isFocused() ? GlassUI.BORDER_BRIGHT : GlassUI.BORDER);
